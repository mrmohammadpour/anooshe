      ...
      <Grid container rowSpacing={1} >
        ...
        <Grid  item md={12} xs={12}>
            <Box  sx={{ mt:2 ,textAlign: "center"}}>
              <Item  className={classes.title} sx={{ mt:2 , }}> تصویرخودرا آپلود کنید</Item> 
            </Box>
        </Grid>
      </Grid>
          ...
          />
            ...
            <Grid container >
                <Grid item container md={6} xs={12}>
                  ...
                  <Item sx={{m:1 }} className={classes.boxto}><typography>{props.name}     </typography></Item>     
                ...
                <Grid item container md={6} xs={12}>
                  <Item className={classes.iconbox}><EngineeringIcon  className={classes.icontex}/></Item>
                  <Item sx={{m:1 }} className={classes.boxto}><typography>{props.lastName}</typography></Item>     
            ...
            <Grid container >
                <Grid item container md={6} xs={12}>
                    ...
                    <Item sx={{mb:5 ,pr:5.4  }}  className={classes.boxin}><Input sx={{mb:0}}  className={classes.textinput} placeholder="کدملی را وارد کنید." /></Item>
                    <Item className={classes.boxico}>
...
{/* =============input1=========== */}
              ...
              <Grid container >
                <Grid item justifyContent="center" container md={12} xs={12}>
