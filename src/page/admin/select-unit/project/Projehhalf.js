 ...
 */}
              <Box sx={{display: 'flex',flexDirection: 'row',bgcolor: 'background.paper',flex:1 }} >
                <Item className={classes.iconboxhalf}><QrCode2Icon  className={classes.icontexhalf}/></Item>
                <Item sx={{m:1 }} className={classes.boxtohalf}><typography>کدپروژه</typography></Item>     
                <Item sx={{mb:5 }}  className={classes.boxinhalf}><Input sx={{mb:0}}  className={classes.textinputhalf} placeholder="کدپروژه را وارد کنید." /></Item>
                <Item className={classes.boxicohalf}>
                  {/*   <CancelIcon  className={classes.colorgrhalf}/>
                    <CheckCircleIcon className={classes.colorrehalf}/>*/}
                </Item>
              </Box>

              <Box sx={{display: 'flex',flexDirection: 'row',bgcolor: 'background.paper',flex:1 }} >
                <Item className={classes.iconboxhalf}><BadgeIcon  className={classes.icontexhalf}/></Item>
                <Item sx={{m:1 }} className={classes.boxtohalf}><typography>نام پروژه</typography></Item>     
                <Item sx={{mb:5 }}  className={classes.boxinhalf}><Input sx={{mb:0 }}  className={classes.textinput} placeholder="نام پروژه را وارد کنید." /></Item>
                <Item className={classes.boxicohalf}>
                    {/* <CancelIcon  className={classes.colorgrhalf}/>
                    <CheckCircleIcon className={classes.colorrehalf}/>*/}
                </Item>
              ...
              <Box sx={{display: 'flex',flexDirection: 'row',bgcolor: 'background.paper',flex:1 }} >
                <Item className={classes.iconboxhalf}><CalendarTodayIcon  className={classes.icontexhalf}/></Item>
                <Item sx={{m:1 }} className={classes.boxtohalf}><typography> تاریخ شروع</typography></Item>     
                <Item sx={{mb:2 ,mr:0 }}  className={classes.boxinhalf}>
              ...
              <Box sx={{display: 'flex',flexDirection: 'row',bgcolor: 'background.paper',flex:1 }} >
                <Item className={classes.iconboxhalf}><EngineeringIcon  className={classes.icontexhalf}/></Item>
                <Item sx={{m:1 }} className={classes.boxtohalf}><typography>اجراکننده</typography></Item>     
                <Item sx={{mb:5 }}  className={classes.boxinhalf}><Input sx={{mb:0 }}  className={classes.textinputhalf} placeholder="نام مجری پروژه را وارد کنید" /></Item>
                <Item className={classes.boxicohalf}>
                    {/* <CancelIcon  className={classes.colorgrhalf}/>
                    <CheckCircleIcon className={classes.colorrehalf}/>*/}
                </Item>
              ...
              <Box sx={{display: 'flex',flexDirection: 'row',bgcolor: 'background.paper',flex:1 }} >
                ...
                <Item sx={{m:1 }} className={classes.boxtohalf}><typography>تعدادبلوک</typography></Item>     
                <Item sx={{mb:5 }}  className={classes.boxinhalf}><Input sx={{mb:0}}  className={classes.textinputhalf} placeholder="تعداد بلوک ها را وارد کنید." /></Item>
                <Item className={classes.boxicohalf}>
                   {/* <CancelIcon  className={classes.colorgrhalf}/>
                    <CheckCircleIcon className={classes.colorrehalf}/>*/}
                </Item>
              ...
              <Box sx={{display: 'flex',flexDirection: 'row',bgcolor: 'background.paper',flex:1 }} >
                <Item className={classes.iconboxhalf}><LibraryAddIcon  className={classes.icontexhalf}/></Item>
                <Item sx={{m:1 }} className={classes.boxtohalf}><typography>تعدادواحد</typography></Item>     
                <Item sx={{mb:5 }}  className={classes.boxinhalf}><Input sx={{mb:0 }}  className={classes.textinputhalf} placeholder="تعداد واحد را وارد کنید." /></Item>
                <Item className={classes.boxicohalf}>
                   {/* <CancelIcon  className={classes.colorgrhalf}/>
                    <CheckCircleIcon className={classes.colorrehalf}/>*/}
                </Item>
...
{/* input5  
        ...
        */}    
                <Stack direction="row"   sx={{ mx:12 , my:5  }}>
                  <Stack >
                    <Button className={classes.bgdel} variant="contained">
                      <img  id="frame" src={"/images/delate.png"} width="110px" />
                      </Button>
                  </Stack>
                  <Stack sx={{pr: 2  }}>
                    <Button className={classes.bgsab} variant="contained">
                       <img  id="frame" src={"/images/sabt.png"} width="110px" />
                       </Button>
                  </Stack>
                </Stack>
